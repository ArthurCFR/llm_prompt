...
8.  **Seulement si spécifié ici "{public_cible_reponse}" : Spécifier le public cible du résultat de ce prompt : `{public_cible_reponse}`.**
  ...
  "Nom de Mon Nouveau Cas d'Usage": {
    ...
    if st.session_state.generated_meta_prompt_for_llm:
        ...
        with col_indicator_assist:
            ...
            st.markdown("<div style='color:red; text-align:left; font-size:0.9em; padding-top:0.9em;'>Copier ici : 👇</div>", unsafe_allow_html=True)
