...
st.set_page_config(layout="wide", page_title="🛠️ Le laboratoire des Prompts IA", initial_sidebar_state="auto" )

# --- CUSTOM CSS FOR SIDEBAR TOGGLE TEXT ---
st.markdown("""
    <style>
        /* Completely remove top whitespace */
        ...
        /* Remove padding above welcome message on homepage */
        h1:first-of-type {
            margin-top: 0rem !important;
            padding-top: 0rem !important;
        }
